...
class Hobby extends React.Component {
    ...
    componentDidMount() {
        ...
        return fetch('https://bellybump.fr/api/api_article.php?id_category=4')
            .then((response) => response.json())
            .then((responseJson) => {
                        ...
                        <View style={{flex: 1}}>
                            ...
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
                                {this.state.fontLoaded ? (
                                    <Text style={styles.slogan}>Un mélange heureux de loisir et d'occupation rend l'homme animé et sensible à tous les plaisirs.
                                         </Text>
                                ) : (
