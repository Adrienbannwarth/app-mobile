...
class Name extends React.Component {
    ...
    componentDidMount() {
        ...
        return fetch('https://bellybump.fr/api/api_article.php?id_category=5')
            .then((response) => response.json())
            .then((responseJson) => {
                        ...
                        <View style={styles.quote}>
                            ...
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
                                {this.state.fontLoaded ? (
                                    <Text style={styles.slogan}>Certains prénoms sont comme la bande-annonce du destin de ceux qui le portent.
                                         </Text>
                                ) : (
